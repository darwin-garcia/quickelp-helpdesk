<%-- 
    ...
    Created on : 6/11/2019, 02:31:49 AM
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-responsive">
                                        ...
                                        <%
                                            ...
                                            List<ServicioVO> buscaServicios = serviDAO.buscarServiciosxIdCliente(Integer.parseInt(request.getParameter("id")));
