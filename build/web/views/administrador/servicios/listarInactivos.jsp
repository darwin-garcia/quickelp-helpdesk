<%-- 
    Document   : listarInactivos
    Created on : 5/11/2019, 11:19:08 PM
                ...
                <section class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Listado Servicios Inactivos</li>
                                </ol>
                            </nav>
                        ...
                        <div class="col-12 grid-margin"><!-- Panel del Formulario-->
                            <div class="card">
                                <div class="card-body">
                                    <h1>Lista de Servicios Inactivos</h1>
                                    <table class="table table-responsive">
                                        ...
                                        <%
                                            ...
                                            List<ServicioVO> listaServicios = serviDAO.listadoServiciosInactivosAdmin();
