<%-- 
    ...
    Created on : 10/11/2019, 06:37:46 PM
...
<html lang="es-CO">
    ...
    <!--Generar informe de Servicio. Diagnostico que realiza el tecnico. -->
    <!--***************************************************************************************************** -->
    <head>
        <%
                ...
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    <div class="search-field d-none d-md-block">
                        <form class="d-flex align-items-center h-100" action="#">
                            <h3>Registrar Informe de Diagnostico</h3></form>
                    </div>
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" method="post" action="Diagnostico">
                                            <!--Lista de Servicios -->
