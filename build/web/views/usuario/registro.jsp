                            ...
                            <form class="form-horizontal" method="post" action="Usuario">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <!--numero_id -->
                                            <input id="RegistrarNumeroIdentificacion" name="RegistrarNumeroIdentificacion" type="text" placeholder="*" class="form-control input-md" required="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="RegistrarNombre" name="RegistrarNombre" type="text" placeholder="*" class="form-control input-md" required="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="RegistrarApellido" name="RegistrarApellido" type="text" placeholder="*" class="form-control input-md" required="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="RegistrarTelefono" name="RegistrarTelefono" type="text" placeholder="*" class="form-control input-md" required="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="RegistrarCorreo" name="RegistrarCorreo" type="text" placeholder="ejemplo@mail.com" class="form-control input-md" required="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="RegistrarDireccion" name="RegistrarDireccion" type="text" placeholder="placeholder" class="form-control input-md">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="RegistrarClaveUsuario" name="RegistrarClaveUsuario" type="password" placeholder="*" class="form-control input-md" required="">
