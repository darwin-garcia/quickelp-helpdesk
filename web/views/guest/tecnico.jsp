<%-- 
    Document   : tecnico
    Created on : 29/09/2019, 02:18:18 PM
...
<html lang="es-CO">
    <head>
        <title>Quickelp - Registro de Tecnicos</title>
    ...
    <body>
        <main role="main">
            <header>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark" data-toggle="sticky-onscroll">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="Inicio?accion=raiz">Registro Tecnico</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-content-custom" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="Inicio?accion=NuestrosTecnicos">Nuestros Tecnicos</a>
                                    <a style="color:red" class="dropdown-item" href="Usuario?accion=nuevo_tecnico">Trabaja con nosotros</a>
                                </div>
                            </li>
                ...
                </nav><!-- Fin del menu Navegacion Principal -->
            </header>
            <section>
                <div class="container mt-4" style="margin-top:50px">
                    <div class="card border-info">
                        <div class="card-header bg-info">
                            <h4>Registro de Nuevos Tecnicos</h4>
                        </div>
                        <div class="card-body">
                            <form class="form-horizontal" method="post" action="Usuario">
                                <fieldset>
                                    ...
                                    %>
                                    <!-- Form Name -->
                                    <legend>Registro de nuevo tecnico</legend>
                                    <!-- idUsuario -->
                                    ...
                                    <input type="hidden" value="nuevo_tecnico" name="Peticion">
                                </fieldset>
                            </form>
