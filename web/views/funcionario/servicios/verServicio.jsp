...
<html lang="es-CO">
    <%
        ...
        serv = (ServicioVO) request.getAttribute("servicio");

        //UsuarioVO usu = new UsuarioVO();
        //usu = (UsuarioVO) request.getAttribute("usuario");
        //int idx=usu.getIdUsuario();
        //Usuario_TipoServicioVO tec = null;
        //UsuarioTipoServicioDAO tecDAO = new UsuarioTipoServicioDAO();
        //List<Usuario_TipoServicioVO> listaTecnicos = tecDAO.listarTiposServxId(idx);
        //Iterator<Usuario_TipoServicioVO> iteraTecnicos = listaTecnicos.iterator();

    %>
    <!-- *******************************************************************************************************************-->
    <!--                                    Perfil de Tecnico                                                               -->
    <!--                                     Ver Servicio solicitado                                                        -->
    <!-- ****************************************************************************************************************** -->    
    <head>
        <title>Informacion de Servicio Ticket: <%=serv.getIdServicio()%> </title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    <div class="search-field d-none d-md-block">
                        <form class="d-flex align-items-center h-100" action="#">
                            <h3>Informacion de Servicio Ticket: <%=serv.getIdServicio()%> </h3></form>
                    </div>
                        ...
                        <div class="col-12 grid-margin"><!-- Panel del Formulario-->
                            <div class="card">
                                <div class="card-body">                                  
                                    ...
                                    <p><b>Ticket Servicio: </b><%=serv.getIdServicio()%></p>
                                    <p><b>Fecha de Solicitud: </b><%=serv.getFechaSolicitud()%></p>
                                    <p><b>Tipo de Servicio:</b><%=serv.getIdTipoDelServ().getNomTipoServicio()%></p>
                                    <p><b>Descripcion: </b><%=serv.getDescripcion()%></p> 
                                    <br>
                                    <h4>Datos del Cliente</h4>
                                    <p><b>Tipo Identificacion: </b><%=serv.getIdUsuario().getTipoIdentificacion().getNombreTipoDoc()%></td>
                                    <p><b>Numero Identificacion: </b><%=serv.getIdUsuario().getNumeroIdentificacion()%></p>
                                    <p><b>Nombre: </b><%=serv.getIdUsuario().getNombre()%></p>
                                    <p><b>Apellido: </b><%=serv.getIdUsuario().getApellido()%></p>
                                    <p><b>Telefono: </b><%=serv.getIdUsuario().getTelefono()%></p>
                                    <p><b>Direccion: </b><%=serv.getIdUsuario().getDireccion()%></p>
                                    <p><b>Correo: </b><%=serv.getIdUsuario().getCorreo()%></p> 
