<%-- 
    Document   : listaTecnico
    Created on : 10/11/2019, 02:58:48 PM
...
<html lang="es-CO">
    ...
    <!-- ****************************************************************************************************************** -->    
    <head>
        <title>Listado de Servicios solicitados - Nombre: <%out.print(usu.getNombre());%> <%out.print(usu.getApellido());%>.</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    <div class="search-field d-none d-md-block">
                        <form class="d-flex align-items-center h-100" action="#">
                            <h3>Lista de Servicios disponibles para ${nombre}</h3></form>
                    </div>
                                    ...
                                    <table class="table table-responsive">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-gradient-info btn-icon" href="Diagnostico?accion=registrar_informe&ids=<%=Integer.toString(serv.getIdServicio())%>&id=${idUsu}"><i class="formas fas fa-users-cog"></i>+</a>
                                                    <a class="btn btn-gradient-success btn-icon" href="Reparacion?accion=registrar_informe&ids=<%=Integer.toString(serv.getIdServicio())%>&id=${idUsu}"><i class="formas fas fa-wrench"></i>+</a>
                                                </td>
                                            </tr>
                                            <%}%>
                                        </tbody>
