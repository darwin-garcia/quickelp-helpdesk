<%-- 
    Document   : actualizarFunc
    Created on : 7/11/2019, 04:49:02 PM
                ...
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    <div class="search-field d-none d-md-block">
                        <form class="d-flex align-items-center h-100" action="#">
                            <h3>Modificar Perfil de ${nombre} ${apellido}</h3></form>
                    </div>
                ...
                <section class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <div class="col-12 grid-margin"><!-- Panel del Formulario-->
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><b>Nombre:</b> <%out.print(usu.getNombre()); %> <%out.print(usu.getApellido()); %> </h4>
                                    <h4 class="card-title"><b>Identificacion:</b> <%out.print(usu.getTipoIdentificacion().getNombreTipoDoc());%> <%out.print(usu.getNumeroIdentificacion());%></h4>
                                    ...
                                    <form class="form-horizontal" method="post" action="Usuario">
                                        <fieldset>                               
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" style="color:black">Contraseña Actual</label>
                                                <div class="col-md-4">
                                                    <input id="ModificarClaveUsuario" name="CompruebaClaveUsuario" type="password" placeholder="*" class="form-control input-md" required="">
                                                    <span class="help-block">Minimo 6 digitos</span>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-4 control-label" style="color:black">Nueva Contraseña</label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <a class="btn btn-outline-danger btn-fw" href="Usuario?accion=listar_usuarios"><i class="mdi mdi-keyboard-backspace"></i>Regresar</a>
                                                    <input type="submit" value="Modificar" class="btn btn-outline-success btn-fw">
                                                </div>
                                            </div>
                                            <input type="hidden" value="actualizar_idusutec" name="Peticion"><!--Accion del doPost del Servlet Usuario -->
                                        </fieldset>
                                    </form>
