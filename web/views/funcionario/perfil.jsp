                            ...
                            <div class="card">
                                <div class="card-body">                                  
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                <th>Especialidades de ${nombre}</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><%=tec.getIdTipoSer().getNomTipoServicio()%></td>
                                            </tr>
                                            <%}%>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <a class="btn btn-outline-primary btn-icon-text" href="Usuario?accion=editar_infotecnico&id=${idUsu}"><i class="mdi mdi-file-check btn-icon-prepend"></i>Modificar Informacion</a>
                                            <!-- Boton de Cambiar Contraseña-->
                                            <a class="btn btn-outline-danger btn-fw" href="Usuario?accion=editar_infotecnico&id=${idUsu}"><i class="mdi mdi-reload btn-icon-prepend"></i>Cambiar Contraseña</a>
                                        </div>
                                    </div>
