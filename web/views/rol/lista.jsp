            ...
            <section>
                ...
                <table border="1">
                    ...
                    <%
                        ...
                        List<RolVO> listado = dao.listaRoles();
                        Iterator<RolVO> iterador = listado.iterator();
                    ...
                    <tbody>
                        <tr>                                
                            ...
                            <td>
                                <a class="btn btn-warning" href="Usuario?accion=editar_roles&id=<%=Integer.toString(rol.getIdRol())%>">Editar</a>
                                <a class="btn btn-danger" href="Usuario?accion=eliminar_roles&id=<%=Integer.toString(rol.getIdRol())%>">Eliminar</a>
                            </td>                                                              
                        </tr> 
                        <%}%>
                    </tbody>
                </table>    
                <a class="btn btn-success" href="Usuario?accion=registrar_roles">Registrar Nuevo Rol</a> 
            </section>
            <footer>
