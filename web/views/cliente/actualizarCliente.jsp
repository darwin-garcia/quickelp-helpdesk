<%-- 
    ...
    Created on : 7/11/2019, 04:50:20 PM
                                        ...
                                        <fieldset>                               
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <a class="btn btn-outline-danger btn-fw" href="Sesion?accion=HomeCliente"><i class="mdi mdi-keyboard-backspace"></i>Regresar</a>
                                                    <input type="submit" value="Modificar" class="btn btn-outline-info btn-fw">
                                                </div>
                                            </div>
                                            <input type="hidden" value="actualizar_idusucli" name="Peticion"><!--Accion del doPost del Servlet Usuario -->
                                        </fieldset>
                                    </form>
