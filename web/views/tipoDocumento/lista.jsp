...
<html>
    <head>
        ...
        <title>Lista de Tipos Documento</title>
    </head>
    <body>
        <main>
            <header>
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark"><!--Barra de Navegacion -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">Lista de Tipo Documento</a>
                            </li>
                            <!--Menu de Solicitudes -->
            ...
            <section>
                ...
                <table border="1">
                    ...
                    <%
                        ...
                        TipoDocumentoVO tDoc = null;
                        TipoDocumentoDAO dao = new TipoDocumentoDAO();
                        List<TipoDocumentoVO> listado = dao.listadoTipoDoc();
                        Iterator<TipoDocumentoVO> iterador = listado.iterator();
                ...
                <a class="btn btn-success" href="Usuario?accion=registrar_documentos">Registrar Nuevo Tipo Documento</a> 
            </section>
            <footer>
