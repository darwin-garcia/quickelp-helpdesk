...
<html lang="es-CO">
    <!--***************************************************************************************************** -->
    <!--Encabezado. Dashboard del Administrador. Lista de Usuarios -->
    <!--***************************************************************************************************** -->
    <head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <title>Quickelp. Lista de Usuarios</title>
        <!-- CSS de Terceros -->
                ...
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    <div class="search-field d-none d-md-block">
                        <form class="d-flex align-items-center h-100" action="#">
                            <h3>Consulta de Usuarios Registrados</h3></form>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-responsive">
                                        ...
                                        <%
                                            ...
                                            List<UsuarioVO> listaUsuarios = usDAO.listadoUsuarios();
                                            Iterator<UsuarioVO> iter = listaUsuarios.iterator();
                                        ...
                                        <tbody>
                                            <tr>                                
                                                ...
                                                <td><a class="btn btn-gradient-success btn-icon" href="Usuario?accion=restablecer_usuarios&id=<%=Integer.toString(usu.getIdUsuario())%>"><i class="formas fas fa-user-edit"></i></a>  </td><!--No puede quedar visible -->
                                                <td>
                                                    <a class="btn btn-gradient-info btn-icon" href="Usuario?accion=editar_usuarios&id=<%=Integer.toString(usu.getIdUsuario())%>"><i class="formas fas fa-users-cog"></i></a>
                                                    <a class="btn btn-gradient-danger btn-icon" href="Usuario?accion=eliminar_usuarios&id=<%=Integer.toString(usu.getIdUsuario())%>"><i class="formas fas fa-user-times"></i></a>
                                                </td>                                                              
                                            </tr> 
                                            <%
                                                }
                                    ...
                                    <a class="btn btn-success" href="Usuario?accion=registrar_usuarios"><i class="formas fas fa-user-plus"></i> Nuevo Usuario</a> 
