<%-- 
    Document   : solicitud
    Created on : 10/11/2019, 12:40:45 PM
        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <%
                    ...
                    Iterator<EquipoVO> iteraEquipos = listaEquipos.iterator();
                    ...
                    List<Usuario_TipoServicioVO> listaTecnicos = tecDAO.listarTiposServ();
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal" method="post" action="Servicio">
                                        ...
                                        <!-- Usuario-->
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="selectbasic">Usuario quien solicita el servicio:</label>
                                            <div class="col-md-4">
                                                <select id="RegistrarUsuario" name="RegistrarUsuario" class="form-control">
                                        ...
                                        <!-- Equipos-->
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="selectbasic">Equipo Registrado</label>
                                            <div class="col-md-4">
                                        ...
                                        <!-- Tecnico-->
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="selectbasic">Tecnico a Asignar</label>
                                            <div class="col-md-4">
                                                <select id="RegistrarTecnico" name="RegistrarTecnico" class="form-control">
                                                    <% while (iteraTecnicos.hasNext()) {
                                                        tec = iteraTecnicos.next();%>
                                                    <option value="<%=tec.getIdUsuTipo()%>"><%=tec.getIdUsuario().getNombre()%> <%=tec.getIdUsuario().getApellido()%>. <%=tec.getIdTipoSer().getNomTipoServicio()%></option>
                                                    <%}%>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <a class="btn btn-outline-danger btn-fw" href="Servicio?accion=listar_activos"><i class="mdi mdi-keyboard-backspace"></i>Regresar</a>
                                                <button id="button1id" name="registrar" class="btn btn-outline-info btn-fw"><i class="mdi mdi-content-save"></i>Guardar</button>
                                            </div>
                                        </div>
                                        <input type="hidden" value="registrar_admin" name="Peticion">
