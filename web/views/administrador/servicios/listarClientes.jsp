<%-- 
    ...
    Created on : 6/11/2019, 12:39:12 AM
...
<html lang="es-CO">
    ...
    <head>
        ...
        <title>Listado de Servicios por clientes</title>
        <!-- CSS de Terceros -->
                ...
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    <div class="search-field d-none d-md-block">
                        <form class="d-flex align-items-center h-100" action="#">
                            <h3>Lista de Servicios por Clientes</h3></form>
                    </div>
                        ...
                        <div class="page-header">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Lista Servicios por Cliente</li>
                                </ol>
                            </nav>
                        ...
                        <div class="col-12 grid-margin"><!-- Panel del Formulario-->
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1>Lista de Servicios por Clientes</h1>
