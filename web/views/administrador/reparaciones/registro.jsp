<%-- 
    Document   : registro
    Created on : 2/10/2019, 06:16:53 AM
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark" data-toggle="sticky-onscroll"><!--Barra de Navegacion -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Registro de Reparacion</a>
                        </li>
                        <!--Menu de Solicitudes -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-content-custom" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="Equipo?accion=listar_equipos">Consultar Equipos</a>
                                <a class="dropdown-item" href="Equipo?accion=registrar_equipo">Registrar Equipos</a>
        ...
        <section>
            <form class="form-horizontal" method="post" action="Reparacion">
                <fieldset>
                    ...
                    <!-- Form Name -->
                    <legend>Formulario de Reparaciones</legend>
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="textinput">Garantia</label>  
                        <div class="col-md-4">
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="FechaEntregaRep">Fecha Entrega</label>  
                        <div class="col-md-4">
                            <input id="FechaEntregaRep" name="FechaEntregaRep" type="text" placeholder="1990-01-01" class="form-control input-md" required="">
                    ...
                    <input type="hidden" value="registrar_rep" name="Peticion">
                </fieldset>
            </form>
        </section>
