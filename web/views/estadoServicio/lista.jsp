...
<%@page import="com.quickelp.programa.persistencia.vo.EstadoServicioVO" %>
<%@page import="com.quickelp.programa.persistencia.dao.EstadoServicioDAO" %>
...
<html>
    <head>
        ...
        <title>Lista de Estado Servicio</title>
    </head>
    <body>
        <main>
            <header>
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark"><!--Barra de Navegacion -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">Lista de Estado Servicio</a>
                            </li>
                            <!--Menu de Solicitudes -->
            ...
            <section>
                <h1>Lista de Estado Servicio</h1>
                <table border="1">
                    <thead>
                        <tr>
                            <th>Id. </th>
                    ...
                    <%
                        ...
                        EstadoServicioVO est = null;
                        EstadoServicioDAO dao = new EstadoServicioDAO();
                        List<EstadoServicioVO> listado = dao.listar();
                        Iterator<EstadoServicioVO> iterador = listado.iterator();
                    ...
                    <tbody>
                        <tr>                                
                            <td><%=est.getIdEstadoServicio()%></td>
                            <td><%=est.getNombreEstadoServicio()%></td>
                            <td>
                    ...
                    <!--Falta -->
                <a class="btn btn-success" href="Servicio?accion=registrar_estados">Registrar Nuevo Estado de Servicio</a> 
